...
export type CanvasImageAngleAction = { mode: "generic"; params: CanvasImageAngleParams };
        ...
        <Modal title={null} open={open && Boolean(dataUrl)} onCancel={onClose} footer={null} width={860} centered destroyOnHidden>
            <div className="space-y-5">
                ...
                <div className="flex justify-end">
                    <Button type="primary" size="large" icon={<WandSparkles className="size-4" />} onClick={() => onConfirm({ mode: "generic", params })}>
                        AI 生成
                    </Button>
                </div>
            </div>
