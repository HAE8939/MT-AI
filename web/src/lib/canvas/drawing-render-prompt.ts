export const DRAWING_RENDER_PHOTOGRAPHY_PROMPT = JSON.stringify(
    {
        ...
        target_json_structure: {
            camera_gear: { model: "", lens: "", sensor: "", shutter_speed: "", aperture: "" },
            lighting_setup: { time_of_day: "", weather: "", lighting_direction: "", quality: "", artificial_light: "" },
            architectural_lighting: { interior_illumination: "", exterior_facade_effects: "" },
            landscape_lighting: { hardscape_illumination: "", vegetation_highlighting: "" },
            color_grading: { palette: [], saturation: "", contrast: "" },
            texture_quality: { details: "", surface_descriptions: "", ground_surface: "", foliage_style: "" },
            composition_guide: { type: "", balance: "" },
            atmosphere: { mood: "", feeling: "" },
            technical_quality: { post_processing: "", white_balance: "", tone: "", vignette: "", dynamic_range: "" },
        },
    },
    null,
    2,
